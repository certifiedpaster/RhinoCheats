...
public:
    ...
    void setLabel(const char* lbl,bool appendAnAsteriskAndMarkAsModified=false)  {
        ...
        const int sz = (const int)(strlen(lbl)+1);       // we allocate one char more (optimization for appending an asterisk)
