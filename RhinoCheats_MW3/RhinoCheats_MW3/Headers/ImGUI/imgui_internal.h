...
namespace ImGui
{
	...
	IMGUI_API void          RenderTextClippedColor(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, ImU32 color, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect = NULL);
	IMGUI_API void          RenderTextClippedEx(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
	IMGUI_API void          RenderTextClippedExColor(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, ImU32 color, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
	IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f);
	IMGUI_API void          RenderGradientFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, ImU32 grad_col, bool border = true, float rounding = 0.0f);
