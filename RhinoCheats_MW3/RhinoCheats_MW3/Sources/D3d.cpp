...
{	   	
	...
	*/
	...
	void StyleColorsRed()
	{
		...
		colors[ImGuiCol_CheckMark] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
		...
		colors[ImGuiCol_Separator] = ImVec4(0.98f, 0.26f, 0.26f, 0.50f);
	...
	void StyleColorsOrange()
	{
		...
		colors[ImGuiCol_Separator] = ImVec4(0.98f, 0.49f, 0.26f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsYellow()
	{
		...
		colors[ImGuiCol_Separator] = ImVec4(0.98f, 0.98f, 0.26f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsGreen()
	{
		...
		colors[ImGuiCol_Separator] = ImVec4(0.26f, 0.98f, 0.26f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsBlue()
	{
		...
		colors[ImGuiCol_Separator] = ImVec4(0.26f, 0.49f, 0.98f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsPurple()
	{
		...
		colors[ImGuiCol_ChildBg] = ImVec4(0.16f, 0.16f, 0.16f, 0.54f);
		colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 0.94f);
		colors[ImGuiCol_Border] = ImVec4(0.49f, 0.26f, 0.49f, 0.50f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.20f, 0.20f, 0.20f, 0.00f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.44f, 0.24f, 0.44f, 0.54f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.49f, 0.26f, 0.49f, 0.67f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.49f, 0.26f, 0.49f, 0.40f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
		...
		colors[ImGuiCol_Separator] = ImVec4(0.49f, 0.26f, 0.49f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsNeoGenesys()
	{
		...
		colors[ImGuiCol_Separator] = ImVec4(0.98f, 0.26f, 0.98f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsAesir()
	{
		...
		colors[ImGuiCol_Separator] = ImVec4(0.26f, 0.98f, 0.98f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.37f, 0.37f, 0.37f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.37f, 0.37f, 0.37f, 1.00f);
	...
	void StyleColorsMaya()
	{
		...
		style.Colors[ImGuiCol_ChildWindowBg] = ImVec4(0, 0, 0, 0);
		style.Colors[ImGuiCol_PopupBg] = ImVec4(0.26f, 0.26f, 0.26f, 1.00f);
		style.Colors[ImGuiCol_Border] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
		style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.3f);
		...
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.43f, 0.43f, 0.43f, 1.00f);
		style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.11f, 0.11f, 0.11f, 1.00f);
	...
	{
		ImVec4* colors = ImGui::GetStyle().Colors;
		colors[ImGuiCol_Text] = ImVec4(0.00f, 0.00f, 0.00f, 0.79f);
		...
		colors[ImGuiCol_Border] = ImVec4(0.00f, 0.00f, 0.00f, 0.34f);
		colors[ImGuiCol_BorderShadow] = ImVec4(1.00f, 1.00f, 1.00f, 0.67f);
		...
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.26f, 0.59f, 0.98f, 0.40f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.06f, 0.53f, 0.98f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.26f, 0.59f, 0.98f, 0.66f);
		...
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.26f, 0.59f, 0.98f, 0.53f);
	...
	void LightRedStyle()
	{
		...
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.86f, 0.86f, 0.86f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.98f, 0.98f, 0.98f, 0.53f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.98f, 0.26f, 0.26f, 0.40f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.98f, 0.26f, 0.26f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.98f, 0.06f, 0.06f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.98f, 0.26f, 0.26f, 0.66f);
		...
		colors[ImGuiCol_Separator] = ImVec4(0.39f, 0.39f, 0.39f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.98f, 0.26f, 0.26f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.98f, 0.26f, 0.26f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.98f, 0.26f, 0.26f, 0.53f);
	...
	void LightGreenStyle()
	{
		...
		colors[ImGuiCol_BorderShadow] = ImVec4(1.00f, 1.00f, 1.00f, 0.67f);
		colors[ImGuiCol_FrameBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.66f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.21f, 0.82f, 0.39f, 0.40f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.20f, 0.77f, 0.33f, 0.67f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.96f, 0.96f, 0.96f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.82f, 0.82f, 0.82f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(1.00f, 1.00f, 1.00f, 0.51f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.86f, 0.86f, 0.86f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.98f, 0.98f, 0.98f, 0.53f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.21f, 0.73f, 0.27f, 0.40f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.19f, 0.72f, 0.34f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.05f, 0.73f, 0.29f, 1.00f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.18f, 0.70f, 0.31f, 0.66f);

		colors[ImGuiCol_SliderGrab] = ImVec4(0.17f, 0.69f, 0.32f, 0.78f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.18f, 0.69f, 0.30f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.17f, 0.66f, 0.29f, 0.40f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.18f, 0.67f, 0.18f, 1.00f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.04f, 0.72f, 0.08f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(0.18f, 0.71f, 0.17f, 0.31f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.20f, 0.72f, 0.26f, 0.80f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.19f, 0.71f, 0.32f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.39f, 0.39f, 0.39f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.18f, 0.70f, 0.23f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.19f, 0.70f, 0.26f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.18f, 0.71f, 0.21f, 0.53f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.18f, 0.70f, 0.28f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.18f, 0.70f, 0.26f, 0.95f);

		colors[ImGuiCol_PlotLines] = ImVec4(0.39f, 0.39f, 0.39f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.19f, 0.72f, 0.38f, 0.35f);
		colors[ImGuiCol_ModalWindowDarkening] = ImVec4(0.20f, 0.20f, 0.20f, 0.35f);
		colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
		colors[ImGuiCol_NavHighlight] = ImVec4(0.45f, 0.45f, 0.90f, 0.80f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
	...
	{
		ImVec4* colors = ImGui::GetStyle().Colors;
		colors[ImGuiCol_Text] = ImVec4(1.00f, 1.00f, 1.00f, 0.81f);
		colors[ImGuiCol_TextDisabled] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
...
#define IMGUI_FONT_SIZE_ 14.0f
	...
	void DarkGreenStyle()
	{
		...
		colors[ImGuiCol_Border] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.3f);
		colors[ImGuiCol_FrameBg] = ImVec4(0.16f, 0.48f, 0.17f, 0.54f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.26f, 0.98f, 0.28f, 0.40f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.26f, 0.98f, 0.28f, 0.67f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.04f, 0.04f, 0.04f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.16f, 0.48f, 0.19f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.00f, 0.00f, 0.00f, 0.51f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.16f, 0.16f, 0.16f, 0.94f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.21f, 0.73f, 0.27f, 0.40f);
		...
		colors[ImGuiCol_SliderGrab] = ImVec4(0.24f, 0.88f, 0.28f, 1.00f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.29f, 0.98f, 0.26f, 1.00f);
		colors[ImGuiCol_Button] = ImVec4(0.26f, 0.98f, 0.35f, 0.40f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.26f, 0.98f, 0.32f, 0.70f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.06f, 0.98f, 0.14f, 0.81f);
		...
		colors[ImGuiCol_Separator] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.10f, 0.75f, 0.22f, 0.78f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.10f, 0.75f, 0.22f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.26f, 0.98f, 0.28f, 0.25f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.26f, 0.98f, 0.28f, 0.67f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.26f, 0.98f, 0.37f, 0.95f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.70f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.60f, 0.00f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.26f, 0.98f, 0.37f, 0.35f);
		colors[ImGuiCol_ModalWindowDarkening] = ImVec4(0.80f, 0.80f, 0.80f, 0.35f);
		colors[ImGuiCol_DragDropTarget] = ImVec4(1.00f, 1.00f, 0.00f, 0.90f);
		colors[ImGuiCol_NavHighlight] = ImVec4(0.26f, 0.98f, 0.40f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 1.00f, 1.00f, 0.70f);
	...
	void SetStyle()
	{
		...
		if (ImGui::Combo("Colors", &Settings[style_color].Value.iValue, "Red\0Orange\0Yellow\0Green\0Blue\0Purple\0NeoGenesys\0Aesir\0Maya\0LightBlue\0LightRed\0LightGreen\0DarkBlue\0DarkRed\0DarkGreen\0"))
		{
			...
			case 6: StyleColorsNeoGenesys(); break;
			case 7: StyleColorsAesir(); break;
			case 8: StyleColorsMaya(); break;

			case 9:  LightBlueStyle(); break;
			case 10: LightRedStyle(); break;
			case 11: LightGreenStyle(); break;
			case 12: DarkBlueStyle(); break;
			case 13: DarkRedStyle(); break;
			case 14: DarkGreenStyle(); break;
			}
		}
	...
	public:
		...
		void    Draw(const char* title, bool* p_open)
		{
			...
			if (ImGui::SmallButton("Help")) {
				...
				AddLog("1. rc_name <value>\n\t\tChanges your name.");
				AddLog("2. rc_xp <max|number>\n\t\tGives you the xp you need.");
				...
				if (!isTekno)
				{
					...
					AddLog("10. rc_derank <id>\n\t\tDerank the player by id, (without id): Show the player list. (as host).");
					AddLog("11. rc_rerank <id>\n\t\tRerank the player by id, (without id): Show the player list. (as host).");
				}			
		...
		void    ExecCommand(const char* command_line)
		{
			...
			else if (Stricmp(Output.cmdName, "rc_maprestart") == 0 && !isTekno)
			{
				...
				else
				{
					...
					DWORD dwMr = /*0x0056EF50*/ Offsets::rMapRestart;
					__asm
					{
						push 0
						push 0
			...
			else if (Stricmp(Output.cmdName, "rc_scorelimit") == 0 && !isTekno)
			{
			...
			else if (Stricmp(Output.cmdName, "rc_timelimit") == 0 && !isTekno)
			{
			...
			else if (Stricmp(Output.cmdName, "rc_xp") == 0)
			{
				...
				else
				{
					...
					if (xpvalue >= 0 && xpvalue <= 1746200)
					{
						pStats->xp = xpvalue;
					}
					else
					{
						AddLog("[error] the number need to be >= 0 and <= 1746200.");
					}
				}
				AddLog("rc_xp done.");
			}
			else if (Stricmp(Output.cmdName, "rc_prestige") == 0)
			{
				...
				else
				{
					...
					if (prestigevalue >= 0 && prestigevalue <= 20)
					{
						pStats->prestige = prestigevalue;
					}
					else
					{
						AddLog("[error] the number need to be >= 0 and <= 20.");
					}
				}

				AddLog("rc_prestige done.");
			}
			else if (Stricmp(Output.cmdName, "rc_tokens") == 0)
			{
				AddLog("rc_tokens executed.");
				...
				{
					int tokens = atoi(Output.cmdArgs[0]);
					if (tokens >= 0 && tokens <= 255)
					{
						pStats->tokens = tokens;
					}
					else
					{
						AddLog("[error] the number need to be >= 0 and <= 255.");
					}
				}

				AddLog("rc_tokens done.");
			}
			else if (Stricmp(Output.cmdName, "rc_31") == 0)
			{
				AddLog("rc_31 executed.");

				if (pStats)
				{

					//179601 snipers, assault rifles, sub.
					//14000 pistols, rockets, riot.

					pStats->usp_exp = 14000; //0x0000 
					pStats->mp412_exp = 14000; //0x0004 
					pStats->magnum44_exp = 14000; //0x0008 
					pStats->deserteagle_exp = 14000; //0x000C 
					pStats->p99_exp = 14000; //0x0010 
					pStats->fiveseven_exp = 14000; //0x0014 

					pStats->acr_exp = 179601; //0x0018 
					pStats->type95_exp = 179601; //0x001C 
					pStats->m4a1_exp = 179601; //0x0020 
					pStats->ak47_exp = 179601; //0x0024 
					pStats->m16a4_exp = 179601; //0x0028 
					pStats->mk14_exp = 179601; //0x002C 
					pStats->g36c_exp = 179601; //0x0030 
					pStats->scar_exp = 179601; //0x0034 
					pStats->fad_exp = 179601; //0x0038 
					pStats->cm901_exp = 179601; //0x003C 

					pStats->mp5_exp = 179601; //0x0040 
					pStats->pm9_exp = 999999; //0x0044 
					pStats->p90_exp = 179601; //0x0048 
					pStats->pp90m1_exp = 179601; //0x004C 
					pStats->ump45_exp = 179601; //0x0050 
					pStats->mp7_exp = 179601; //0x0054 

					pStats->fmg9_exp = 14000; //0x0058 
					pStats->g18_exp = 14000; //0x005C 
					pStats->mp9_exp = 14000; //0x0060 
					pStats->scorpion_exp = 14000; //0x0064 

					pStats->spas12_exp = 179601; //0x006C 
					pStats->aa12_exp = 179601; //0x0070 
					pStats->striker_exp = 179601; //0x0074 
					pStats->model1887_exp = 179601; //0x0078 
					pStats->usas12_exp = 179601; //0x007C 
					pStats->ksg12_exp = 179601; //0x0080 


					pStats->m60e4_exp = 179601; //0x0084 
					pStats->mk46_exp = 179601; //0x0088 
					pStats->pkppecheneg_exp = 179601; //0x008C 
					pStats->l86lsw_exp = 179601; //0x0090 
					pStats->mg36_exp = 179601; //0x0094 


					pStats->barrett50_exp = 179601; //0x0098 
					pStats->msr_exp = 179601; //0x009C 
					pStats->rsass_exp = 179601; //0x00A0 
					pStats->dragunov_exp = 179601; //0x00A4 
					pStats->as50_exp = 179601; //0x00A8 
					pStats->l118a_exp = 179601; //0x00AC 


					pStats->rpg7_exp = 14000; //0x00B4 
					pStats->javelin_exp = 14000; //0x00D0 
					pStats->stinger_exp = 14000; //0x00D4 
					pStats->smaw_exp = 14000; //0x00D8 
					pStats->m320_exp = 14000; //0x00DC 	
					pStats->xm25_exp = 14000; //0x0104 


					pStats->riotshield_exp = 14000; //0x00F8 




					pStats->ExtremeConditioning = 422400; //0x1A02 
					pStats->SleightOfHand = 148; //0x1A06 
					pStats->Scavenger = 148; //0x1A0A 
					pStats->BlindEye = 148; //0x1A0E 
					pStats->Recon = 148; //0x1A12 
					pStats->Hardline = 148; //0x1A16 
					pStats->Assassin = 148; //0x1A1A 
					pStats->Quickdraw = 148; //0x1A1E 
					pStats->Overkill = 148; //0x1A22 
					pStats->BlastShield = 148; //0x1A26 
					pStats->Marksman = 148; //0x1A2A 
					pStats->Sitrep = 148; //0x1A2E 
					pStats->SteadyAim = 148; //0x1A32 
					pStats->DeadSilence = 148; //0x1A36 
					pStats->Stalker = 148; //0x1A3A 
					pStats->Parkour = 148; //0x1A3E 
					pStats->HighNoon = 148; //0x1A42 
					pStats->HoardingAmmo = 148; //0x1A46 
					pStats->RestrictedAirspace = 148; //0x1A4A 
					pStats->PaintballGun = 148; //0x1A4E 
					pStats->AndOne = 148; //0x1A52 
					pStats->Surprise = 148; //0x1A56 
					pStats->BringingTheBoom = 148; //0x1A5A 
					pStats->Overkiller = 148; //0x1A5E 
					pStats->CantPhaseMe = 148; //0x1A62 
					pStats->CQCNotForMe = 148; //0x1A66 
					pStats->IHeardThat = 148; //0x1A6A 
					pStats->RunnersHigh = 148; //0x1A6E 
					pStats->Featherweight = 148; //0x1A72 
					pStats->TripDelayed = 148; //0x1A76


				}

				AddLog("rc_31 done. (Don't forget to play to save changes).");
			}
			...
			else if (Stricmp(Output.cmdName, "rc_derank") == 0 && !isTekno)
			{
				/*
				...
				Command: r_derank - Args: 0

				# r_derank 12 23 4 652 636 7x ssf 324

				Hello World!

				Command: r_derank - Args: 8
				Argument #1: 12
				Argument #2: 23
				Argument #3: 4
				Argument #4: 652
				...
				{
				char tabuf[256];
				sprintf(tabuf, "Argument #%d: %s\n", i + 1, Output.cmdArgs[i]);
				memcpy(abuf + strlen(abuf), tabuf, strlen(tabuf) + 1);
				}
				AddLog("\nHello World!\n\nCommand: %s - Args: %d\n%s\n", Output.cmdName, Output.argNum, abuf);

				*/

				AddLog("rc_derank executed.");
				...
				else
				{
					if (cg && cgs)
					{
						if (!Output.argNum)
						{
							...
							{
								clientInfo_t *pClient = Engine.GetClient(i);
								if (pClient)
								{
									char tabuf[256];
									sprintf(tabuf, "[%i]: %s\n", i, pClient->name);
						...
						{
							/*	int id = atoi(Output.cmdArgs[0]);
							if (!*(BYTE *)(493208 * id + 0x4BA224D) || *(DWORD *)(493208 * id + 0x4B5CF90) == 2)
							{
							AddLog("Condition for id: %i\n", id);
							return;
							}	*/
							...
							if (id >= 0 && id < 18)
							{
								clientInfo_t *pClient = Engine.GetClient(id);
								if (pClient)
								{
									AddLog("selected player: %s\n", pClient->name);
									SafeCreateThread(nullptr, 0, reinterpret_cast<LPTHREAD_START_ROUTINE>(Host::Derank), Output.cmdArgs[0], 0, nullptr);
									AddLog("rc_derank done, end the game (disconnect in console) to save changes.");
									return;
								}
							}
							else
							{
								AddLog("[error] the id must be between 0 and 17.");
							}
						}
					}
				}

				AddLog("rc_derank done.");

			}
			else if (Stricmp(Output.cmdName, "rc_rerank") == 0 && !isTekno)
			{
				AddLog("rc_rerank executed.");
					...
					if (cg && cgs)
					{
						...
						else
						{
							...
							if (id >= 0 && id < 18)
							{
								...
								{
									AddLog("selected player: %s\n", pClient->name);
									SafeCreateThread(nullptr, 0, reinterpret_cast<LPTHREAD_START_ROUTINE>(Host::Rerank), Output.cmdArgs[0], 0, nullptr);
									AddLog("rc_rerank executed, end the game (disconnect in console) to save changes.");
									return;
								}
							}
							else
	...
	void DrawMenu() {
		...
		//Enable/Disable Mouse
		{
			...
			static DWORD dwRestore = 0;//, dwKeyRestore = 0; static BYTE btKeyRestore = 0;
			...
			if (!bSetValues && g_bMainWindowOpen)
			{
				...
				*(PDWORD)Offsets::mouse = 0;
				...
				/*//0x105E5EC menu, turn off.-- no sound :)
				dwKeyRestore = *(PDWORD)0x105E5EC;//0xB38760;//
				*(PDWORD)0x105E5EC = 0;
				btKeyRestore = *(PDWORD)0xB33868;//0xB38760;//
				*(PDWORD)0xB33868 = 0;*/
			...
			else if (bSetValues && !g_bMainWindowOpen)
			{
				...
				*(PDWORD)Offsets::mouse = dwRestore;
				...
				/**(PDWORD)0x105E5EC = dwKeyRestore;
				*(PDWORD)0xB33868 = btKeyRestore;*/
					...
					xSize = 555;
				{
					...
					case 4:
						if (!isTekno)
						{
							ImGui::BeginChild("HOST Child", ImVec2(0, 295), true);
							{
								...
								ImGui::Checkbox("Enabled", &Settings[host_forcehost].Value.bValue);
...

								{
									...
									if (ImGui::Button("Force it!") && !bForced && !*(int*)Offsets::host)
									{
									...
									ImGui::Combo("Map", &Settings[host_map].Value.iValue, maps, IM_ARRAYSIZE(maps));
									ImGui::PopItemWidth();
									...
									ImGui::PushItemWidth(127);
									ImGui::Combo("Gametype", &Settings[host_gametype].Value.iValue, gametypes, IM_ARRAYSIZE(gametypes));
									ImGui::PopItemWidth();
									...
									ImGui::SameLine(XmodSize);
									static const char* tms[] = { "Off", "Over your head", "To your crosshair" };
									ImGui::PushItemWidth(110);
									ImGui::Combo("Teleport mode", &Settings[host_teleport].Value.iValue, tms, IM_ARRAYSIZE(tms));
									ImGui::PopItemWidth();

									ImGui::Checkbox("Mass kill", &Settings[host_masskill].Value.bValue);
									ImGui::SameLine(XmodSize);
									ImGui::Checkbox("Jump", &Settings[host_jump].Value.bValue);

									ImGui::Checkbox("Unlimited ammo", &Settings[host_unlimited_ammo].Value.bValue);
									ImGui::SameLine(XmodSize);
									ImGui::Checkbox("Visions", &Settings[host_visions].Value.bValue);

									ImGui::Checkbox("Anti leave", &Settings[host_antileave].Value.bValue);
									ImGui::SameLine(XmodSize + 17);
									ImGui::PushItemWidth(90);
									ImGui::SliderInt("Seconds between visions", &Settings[host_visions_time].Value.iValue, 1, 10);
									ImGui::PopItemWidth();

									ImGui::Checkbox("One hit", &Settings[host_unfair].Value.bValue);
									ImGui::SameLine(XmodSize);
									ImGui::Checkbox("Claps everyone", &Settings[host_clap].Value.bValue);
									ImGui::Checkbox("Rapid fire", &Settings[host_rapidfire].Value.bValue);
									ImGui::SameLine(XmodSize);
									ImGui::Checkbox("Sesh's bomb", &Settings[host_killstreak].Value.bValue);
									ImGui::Checkbox("No clip", &Settings[host_noclip].Value.bValue);
									ImGui::SameLine(XmodSize);
									ImGui::Checkbox("Glitch guns", &Settings[host_glitchgun].Value.bValue);
									ImGui::Checkbox("Speed", &Settings[host_speed].Value.bValue);
									ImGui::SameLine(XmodSize);
									ImGui::Checkbox("Hear everyone", &Settings[host_heareveryone].Value.bValue);
								}
						...
						{
							ImGui::BeginChild("HOST Child", ImVec2(0, 295), true);
							ImGui::Text("Allowed for the steam version.");
							ImGui::EndChild();
						}
					...
					case 5:
						ImGui::BeginChild("Keys Child", ImVec2(0, 295), true);
						{
							...
							ImGui::Text("F1: Force class"); ImGui::SameLine(200); ImGui::Text("Numpad 1: Force class 1");
							ImGui::Text("F2: Switch team"); ImGui::SameLine(200); ImGui::Text("Numpad 2: Force class 2");
							ImGui::Text("F3: Force jug"); ImGui::SameLine(200); ImGui::Text("Numpad 3: Force class 3");
							ImGui::Text("F4: Go spectator"); ImGui::SameLine(200); ImGui::Text("Numpad 4: Force class 4");
							ImGui::Text("F5: God mode"); ImGui::SameLine(200); ImGui::Text("Numpad 5: Force class 5");
							ImGui::Text("F6: Force class 11"); ImGui::SameLine(200); ImGui::Text("Numpad 6: Force class 6");
							ImGui::Text("F7: Force class 12"); ImGui::SameLine(200); ImGui::Text("Numpad 7: Force class 7");
							ImGui::Text("F8: Force class 13"); ImGui::SameLine(200); ImGui::Text("Numpad 8: Force class 8");
							ImGui::Text("F9: Force class 14"); ImGui::SameLine(200); ImGui::Text("Numpad 9: Force class 9");
							ImGui::Text("F10: Force class 15"); ImGui::SameLine(200); ImGui::Text("Numpad 0: Force class 10");
							if (!isTekno)
								ImGui::Text("END: End game");
						}
						ImGui::EndChild();
						break;
	...
	void DrawInfo()
	{
		if (Settings[show_info].Value.bValue)
		{
			...
			ImGui::Begin("Info", &Settings[show_info].Value.bValue, Settings[window_info_size].Value.v2Value, -1.0f, ImGuiWindowFlags_NoCollapse);
			{
				...
				if (perk_bulletPenetrationMultiplier && perk_bulletPenetrationMultiplier->u6.fval)
					ImGui::Text("Bpm: %f", perk_bulletPenetrationMultiplier->u6.fval);

				/*ImGui::Text("Odata: 0x%X", *PDWORD(Offsets::isplaying));
				if (*PDWORD(Offsets::isplaying) & 0x1800)
					ImGui::TextColored(ImVec4(0.0f, 1.0f, 0.0f, 1.0f), "1800!");
				else if (*PDWORD(Offsets::isplaying) & 0x1000)
					ImGui::TextColored(ImVec4(0.0f, 0.0f, 1.0f, 1.0f), "1000!");
				else if (*PDWORD(Offsets::isplaying) & 0x2)
					ImGui::TextColored(ImVec4(1.0f, 0.0f, 0.0f, 1.0f), "2!");
				else if (*PDWORD(Offsets::isplaying) & 0x4)
					ImGui::TextColored(ImVec4(1.0f, 1.0f, 0.0f, 1.0f), "4!");
				*/
											   

				/*ImGui::Text("IsPlaying: normal:[%i], hexed:[0x%X]", *PDWORD(Offsets::isplaying), *PDWORD(Offsets::isplaying));

				ImGui::Text("Killcam: %i", *(int*)Offsets::killcam);
				
				if (refdef != nullptr)
				{
					ImGui::Text("Refdef->ViewOrg 0: %f", refdef->vieworg[0]);
					ImGui::Text("Refdef->ViewOrg 1: %f", refdef->vieworg[1]);
					ImGui::Text("Refdef->ViewOrg 2: %f", refdef->vieworg[2]);
				}

				if (cg)
					ImGui::Text("State: %i", cg->state);

				ImGui::Text("Distance to target: %f", Aim.DistanceToTarget);*/
	...
	DWORD _ProxyReturnAddress = NULL;
	PDWORD pData = nullptr;
	PCHAR pModel = nullptr;
	DWORD dwAddress = NULL;

	bool bTeamAxis(char *pModel)
	{
		if (strstr(pModel, "henchmen")
			|| strstr(pModel, "russian")
			|| strstr(pModel, "militia")
			|| strstr(pModel, "sniper")
			|| strstr(pModel, "chicken")
	...
	{
		if (strstr(pModel, "delta")
			|| strstr(pModel, "sas")
			|| strstr(pModel, "gign")
			|| strstr(pModel, "_pmc_africa_")
			|| strstr(pModel, "_keegan_africa_")
			|| strstr(pModel, "_price_africa_")
			|| strstr(pModel, "_soap_africa_")
			|| strstr(pModel, "_nikolai_africa_"))
			return true;
	...
	HRESULT __stdcall DrawIndexedPrimitiveHook(IDirect3DDevice9* pDevice, D3DPRIMITIVETYPE Type, INT BaseVertexIndex, UINT MinIndex, UINT NumVertices, UINT StartIndex, UINT PrimitiveCount)
	{
		...
		if (!_ProxyReturnAddress ||
			!(_ProxyReturnAddress == Offsets::d3d_ra_1 ||
				_ProxyReturnAddress == Offsets::d3d_ra_2 ||
				_ProxyReturnAddress == Offsets::d3d_ra_3 ||
				_ProxyReturnAddress == Offsets::d3d_ra_4 ||
				_ProxyReturnAddress == Offsets::d3d_ra_5 ||
				_ProxyReturnAddress == Offsets::d3d_ra_6 ||

				_ProxyReturnAddress == Offsets::d3d_ra_7 ||
				_ProxyReturnAddress == Offsets::d3d_ra_8 ||

				_ProxyReturnAddress == Offsets::d3d_ra_9 ||
				_ProxyReturnAddress == Offsets::d3d_ra_10 ||
				_ProxyReturnAddress == Offsets::d3d_ra_11 ||
				_ProxyReturnAddress == Offsets::d3d_ra_12 ||
				_ProxyReturnAddress == Offsets::d3d_ra_13)
			)
			return OrigDrawIndexedPrimitive(pDevice, Type, BaseVertexIndex, MinIndex, NumVertices, StartIndex, PrimitiveCount);
		...
		__asm mov dwAddress, ebp
		if (!dwAddress)
			return OrigDrawIndexedPrimitive(pDevice, Type, BaseVertexIndex, MinIndex, NumVertices, StartIndex, PrimitiveCount);

		dwAddress = dwAddress + 0x2c;
		pData = reinterpret_cast<PDWORD>(dwAddress);
		if (pData != nullptr)
		{
			dwAddress = *reinterpret_cast<PDWORD>(pData);
			if (!dwAddress)
				return OrigDrawIndexedPrimitive(pDevice, Type, BaseVertexIndex, MinIndex, NumVertices, StartIndex, PrimitiveCount);

			dwAddress = dwAddress + 0x28;
			pData = reinterpret_cast<PDWORD>(dwAddress);
			if (pData != nullptr)
			{
				dwAddress = *reinterpret_cast<PDWORD>(pData);
				...
				if (pData != nullptr)
				{
					...
					pModel = reinterpret_cast<PCHAR>(dwAddress);
					if (pModel != nullptr)
					{
						/*if (GetAsyncKeyState(VK_DELETE))
						{
							char pStrBuffer[128];
							sprintf_s(pStrBuffer, "-pModel: [%s], _pRA: [0x%X]\n", pModel, _ProxyReturnAddress);
							console.AddLog(pStrBuffer);
						}*/

						if (Settings[d3d_nosmoke].Value.bValue && _ProxyReturnAddress == Offsets::d3d_ra_13 &&
							(strstr(pModel, "gfx_smk_")))
							return D3D_OK;

						/*if (Settings[d3d_tripmap].Value.bValue && texMap)
						{	Client's screen
							if (!(strstr(pModel, "additive") || strstr(pModel, "postfx")))
								pDevice->SetTexture(0, texMap);
						}*/

						if (Settings[d3d_tripmap].Value.bValue && texMap && _ProxyReturnAddress != Offsets::d3d_ra_9)
						{
							if (strstr(pModel, "wc/")
								|| strstr(pModel, "mc/")
								|| strstr(pModel, "m/"))
						...
						if (_ProxyReturnAddress == /*0x0069FBD4*/ Offsets::d3d_ra_9)
						{
							if (Settings[d3d_chams_wireframe].Value.bValue)
								pDevice->SetRenderState(D3DRS_FILLMODE, D3DFILL_SOLID);
						}
						else if (_ProxyReturnAddress == /*0x006A1C70*/ Offsets::d3d_ra_10)//6A1BE0 r_dmsc players
						{
							/*
							006A1BE0   83EC 10          SUB ESP,0x10
							006A1BE3   0FB748 02        MOVZX ECX,WORD PTR DS:[EAX+0x2]
							006A1BE7   0FB750 04        MOVZX EDX,WORD PTR DS:[EAX+0x4]
							006A1BEB   894C24 04        MOV DWORD PTR SS:[ESP+0x4],ECX
							006A1BEF   895424 08        MOV DWORD PTR SS:[ESP+0x8],EDX
							006A1BF3   8D4C24 0C        LEA ECX,DWORD PTR SS:[ESP+0xC]
							006A1BF7   51               PUSH ECX
							006A1BF8   8B48 10          MOV ECX,DWORD PTR DS:[EAX+0x10]
							006A1BFB   8D5424 04        LEA EDX,DWORD PTR SS:[ESP+0x4]
							006A1BFF   52               PUSH EDX
							006A1C00   0FB650 06        MOVZX EDX,BYTE PTR DS:[EAX+0x6]
							006A1C04   51               PUSH ECX
							006A1C05   52               PUSH EDX
							006A1C06   E8 F59BE2FF      CALL iw5mp.004CB800
							006A1C0B   8B4424 28        MOV EAX,DWORD PTR SS:[ESP+0x28]
							006A1C0F   8B4C24 10        MOV ECX,DWORD PTR SS:[ESP+0x10]
							006A1C13   05 C0000000      ADD EAX,0xC0
							006A1C18   83C4 10          ADD ESP,0x10
							006A1C1B   3948 04          CMP DWORD PTR DS:[EAX+0x4],ECX
							006A1C1E   74 11            JE SHORT iw5mp.006A1C31
							006A1C20   8948 04          MOV DWORD PTR DS:[EAX+0x4],ECX
							006A1C23   8B00             MOV EAX,DWORD PTR DS:[EAX]
							006A1C25   8B10             MOV EDX,DWORD PTR DS:[EAX]
							006A1C27   51               PUSH ECX
							006A1C28   50               PUSH EAX
							006A1C29   8B82 A0010000    MOV EAX,DWORD PTR DS:[EDX+0x1A0]
							006A1C2F   FFD0             CALL EAX
							006A1C31   8B5424 14        MOV EDX,DWORD PTR SS:[ESP+0x14]
							006A1C35   8B82 08140000    MOV EAX,DWORD PTR DS:[EDX+0x1408]
							006A1C3B   8B4C24 1C        MOV ECX,DWORD PTR SS:[ESP+0x1C]
							006A1C3F   6A 20            PUSH 0x20
							006A1C41   51               PUSH ECX
							006A1C42   8B88 70190400    MOV ECX,DWORD PTR DS:[EAX+0x41970]
							006A1C48   8B51 08          MOV EDX,DWORD PTR DS:[ECX+0x8]
							006A1C4B   8B4424 20        MOV EAX,DWORD PTR SS:[ESP+0x20]
							006A1C4F   52               PUSH EDX
							006A1C50   05 C0000000      ADD EAX,0xC0
							006A1C55   50               PUSH EAX
							006A1C56   E8 B506FCFF      CALL iw5mp.00662310
							006A1C5B   8B5424 28        MOV EDX,DWORD PTR SS:[ESP+0x28]
							006A1C5F   8D4C24 14        LEA ECX,DWORD PTR SS:[ESP+0x14]
							006A1C63   51               PUSH ECX
							006A1C64   81C2 C0000000    ADD EDX,0xC0
							006A1C6A   52               PUSH EDX
							006A1C6B   E8 E06CFEFF      CALL iw5mp.00688950
							006A1C70   83C4 28          ADD ESP,0x28  <<<<<<<
							006A1C73   C3               RETN

							iw5mp Base 400000 Size 68a5000 \x83\xC4\x28\xC3\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\xCC\x83\xEC\x0C xxxxxxxxxxxxxxxxxxx

							*/

							/*if (GetAsyncKeyState(VK_DELETE))
							{
							//if (strstr(pModel, "mc/mtl"))
							{
							char pStrBuffer[128];
							sprintf_s(pStrBuffer, "-pModel(r_dmsc): %s\n", pModel);
							CG_PrintToConsole(pStrBuffer);
							}
							}
							mc/mtl_viewmodel_ghillie_desert_glove
							mc/mtl_viewmodel_russian_sleeve_b
							mc/mtl_iw5_ghillie_desert
							*/
						...
						else if (_ProxyReturnAddress == /*0x665020*/ Offsets::d3d_ra_11) //weapons
						{
							/*

							00664FF5   E8 5668E6FF      CALL iw5mp.004CB850
							00664FFA   018424 C4000000  ADD DWORD PTR SS:[ESP+0xC4],EAX
							00665001   0FB74E 06        MOVZX ECX,WORD PTR DS:[ESI+0x6]
							00665005   8D9424 BC000000  LEA EDX,DWORD PTR SS:[ESP+0xBC]
							0066500C   52               PUSH EDX
							0066500D   8D83 C0000000    LEA EAX,DWORD PTR DS:[EBX+0xC0]
							00665013   50               PUSH EAX
							00665014   898C24 C8000000  MOV DWORD PTR SS:[ESP+0xC8],ECX
							0066501B   E8 30390200      CALL iw5mp.00688950
							00665020   83C4 1C          ADD ESP,0x1C <<<<<

							iw5mp Base 400000 Size 68a5000 \x83\xC4\x1C\x83\xC6\x20\x83\xEF\x01\x0F\x85\x00\x00\x00\x00\x8B\x8C\x24\x00\x00\x00\x00 xxxxxxxxxxx????xxx????

							*/

							if (Settings[d3d_noweapon].Value.bValue && bWeapons(pModel))
								return D3D_OK;

							if (Settings[d3d_chams].Value.bValue)
							{
								if (Settings[d3d_chams_weapons].Value.bValue && bWeapons(pModel))
								{
									pDevice->SetRenderState(D3DRS_ZENABLE, D3DZB_FALSE);
						...
						else if (_ProxyReturnAddress == /*0x6A2B37*/ Offsets::d3d_ra_12) //wall sky
						{
							//here.
							if (Settings[d3d_chams_wireframe].Value.bValue)
								pDevice->SetRenderState(D3DRS_FILLMODE, D3DFILL_SOLID);

							if (Settings[d3d_nosky].Value.bValue && strstr(pModel, "wc/sky"))
								return D3D_OK;
	...
	/*
	proxy function:
	004B7920  /$  8B4C24 08     mov ecx, dword ptr ss:[esp+8]
	004B7924  |.  8B4424 04     mov eax, dword ptr ss:[esp+4]
	004B7928  |.  8B00          mov eax, dword ptr ds:[eax]
	004B792A  |.  8B10          mov edx, dword ptr ds:[eax]
	004B792C  |.  8B92 48010000 mov edx, dword ptr ds:[edx+148]
	004B7932  |.  56            push esi
	004B7933  |.  8B71 04       mov esi, dword ptr ds:[ecx+4]
	004B7936  |.  56            push esi                                 ;  primcount
	004B7937  |.  8B71 08       mov esi, dword ptr ds:[ecx+8]
	004B793A  |.  8B09          mov ecx, dword ptr ds:[ecx]
	004B793C  |.  56            push esi                                 ;  startindex
	004B793D  |.  51            push ecx                                 ;  numverticies
	004B793E  |.  6A 00         push 0                                   ;  Minvertexindex
	004B7940  |.  6A 00         push 0                                   ;  basevertexindex
	004B7942  |.  6A 04         push 4                                   ;  Type??
	004B7944  |.  50            push eax                                 ;  D3D9 Dev
	004B7945  |.  FFD2          call edx
	004B7947  |.  5E            pop esi
	004B7948  \.  C3            retn
	*/
	...
	/*
	Proxy hook
	__declspec (naked) DIPProx()
	{

	__asm MOV EAX, DWORD PTR SS:[ESP+0x24]
	__asm MOV ProxRet, EAX;
	__asm JMP h_DrawIndexedPrimitive
	}
	*/
	...
	bool InitAndHookD3D()
	{
		...
		*/
		...
		for (; pVTable == nullptr; SafeSleep(217))
			pVTable = *reinterpret_cast<PDWORD **>(/*0x5FBCC28*/ Offsets::d3d_device);

		while (!(g_hWindow = FindWindowA(0, "Call of Duty\xAE: Modern Warfare\xAE 3 Multiplayer")))
			SafeSleep(/*217*/218);
